...
INSTALLS="github.com/bborbe/debian-utils/bin/create_debian_package github.com/bborbe/debian-utils/bin/create_debian_package_by_config github.com/bborbe/debian-utils/bin/update_apt_source_list"
